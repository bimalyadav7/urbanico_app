...
materialEntryDateContainer(child) => SizedBox(width: 152, height: 152, child: Container(child: child));
              ...
              child: GestureDetector(
                onTap: () {
                  if (!disabled) {
                    ...
                    Provider.of<TimeSheetViewRepo>(context, listen: false).refresh();
                  }
                },
                child: Container(
                  alignment: Alignment.center,
        ...
        child: Align(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text("#${Provider.of<TimeSheetViewRepo>(context).getTicketForTruck(truck)}"),
            ],
          ),
        ),
      ));
...
class MaterialEntryTruckLoadCalculator extends StatelessWidget {
  ...
  List<Widget> showLoadData(context) {
    var storedTruck = Provider.of<TimeSheetViewRepo>(context);
...
class TimesheetMaterialEntry extends StatelessWidget {
  ...
  const TimesheetMaterialEntry({required this.tabController});
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> _makeTitleColumn() {
      ...
      _tempTitleColumn.add(timeSheetCostCodeDataContainer(AddProjectButtonDisabled()));
...
class ConcreteActualField extends StatelessWidget {
  final TimeSheetProject tsproject;
  const ConcreteActualField(this.tsproject);
      ...
      child: Container(
        child: TextFormField(
          ...
          decoration: InputDecoration(
            hintText: tsproject.id.toString(),
...
class AddProjectButtonDisabled extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Center(child: Text("Total", style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold))),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialButton(
      ...
      onPressed: () async {
        ...
        if (timesheetData.listProjects.length == count) {
          await showDialog(
              context: context,
              builder: (BuildContext context) {
                ...
                ], content: const Text("No truck unload specified."));
              });
        } else {
          ...
          await showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  title: const Text("Enter Truck ID"),
                  content: SizedBox(
                    width: 400,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        ...
                        SizedBox(
                          ...
                          child: Form(
                            ...
                            child: TextFormField(
                              ...
                              autofocus: true,
                              decoration: const InputDecoration(hintText: "Truck Detail"),
                              controller: truckcontroller1,
                              validator: (String? text) {
                                if (timesheetData.listTruckName.contains(text)) return "Truck ID Already Present";
                                if (text!.isEmpty) return "Enter Ticket Detail";
                                return "";
                              },
                            ),
                          ),
                        ...
                        SizedBox(
                          ...
                          child: Form(
                            ...
                            child: TextFormField(
                              ...
                              autofocus: false,
                              decoration: const InputDecoration(hintText: "Ticket Number"),
                              controller: truckcontroller2,
                              validator: (text) {
                                if (text!.isEmpty) return "Enter Ticket Number";
                                return "";
                              },
                            ),
                          ),
