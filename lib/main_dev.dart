...
void main() async {
  ...
  AppConfig().setAppConfig(
    ...
    appName: 'Urban Infraconstruction App Development',
    description: '',
    primaryColor: const Color(0xFFf1c40f),
    secondaryColor: const Color(0xFF0a0d1b),
    // baseUrl: 'http://172.21.184.93/TimesheetService/',
    baseUrl: 'http://localhost/TimesheetService/',
    buildDate: "2021-12-23",
    buildVersion: "10",
    expiryOffset: 550,
    tokenValidationTime: 500,
    platform: platform,
  );
