...
void main() async {
  ...
  Hive.registerAdapter(CostCodeAdapter());
  ...
  AppConfig().setAppConfig(
      ...
      appName: 'Urban Infraconstruction App TEST',
      description: '',
      primaryColor: const Color(0xFFf1c40f),
      secondaryColor: const Color(0xFF0a0d1b),
      baseUrl: 'https://testing.urbaniconstruct.com/TimesheetService/',
      buildDate: "2021-12-23",
      buildVersion: "10",
      expiryOffset: 80,
      tokenValidationTime: 100,
      platform: platform);
  runApp(ChangeNotifierProvider(create: (_) => UserRepository(), child: Riverpod.ProviderScope(child: const MyApp())));
}
